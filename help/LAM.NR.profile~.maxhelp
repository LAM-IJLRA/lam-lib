...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 452.0, 127.0, 67.0, 20.0 ],
					"text" : "take profile"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 158.0, 81.0, 22.0 ],
					"text" : "loadmess -70"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 258.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 260.0, 158.0, 183.0, 22.0 ],
					"text" : "LAM.NR.profile~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 260.0, 125.0, 35.0, 22.0 ],
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 342.0, 125.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 424.0, 189.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "LAM.NR.profile~", "@obj-desc", "FFT based noise remover." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
		...
		"parameters" : 		{
			"obj-14::obj-34::obj-1" : [ "live.menu[2]", "live.menu", 0 ],
