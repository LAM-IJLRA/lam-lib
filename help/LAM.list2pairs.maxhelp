...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 216.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 136.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "a b c d e"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 176.0, 86.0, 22.0 ],
					"style" : "",
					"text" : "LAM.list2pairs"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "LAM.list2pairs", "@obj-desc", "Output every possible association of 2 elements without duplicates." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
