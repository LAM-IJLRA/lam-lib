...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 254.0, 75.0, 33.0 ],
					"text" : "print eject @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 61.0, 335.0, 20.0 ],
					"text" : "More info : https://en.wikipedia.org/wiki/Double-ended_queue"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 254.0, 70.0, 33.0 ],
					"text" : "print pop @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 411.0, 194.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 329.0, 167.666672, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 411.0, 254.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 247.0, 141.333328, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 165.0, 222.0, 265.0, 22.0 ],
					"text" : "LAM.deque"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "LAM.deque", "@obj-desc", "Double ended queue." ],
					"id" : "obj-5",
					"maxclass" : "bpatcher",
