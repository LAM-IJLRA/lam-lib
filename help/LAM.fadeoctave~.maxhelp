...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.0, 271.0, 243.0, 33.0 ],
					"text" : "arguments : number of fading octaves, synthName"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "LAM.fadeoctave~", "@obj-desc", "Octave dispatch and fading." ],
					"id" : "obj-5",
					"maxclass" : "bpatcher",
