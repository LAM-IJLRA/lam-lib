...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 129.0, 114.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 129.0, 219.0, 100.0, 22.0 ],
					"text" : "print"
				}
...
,
					...
					"patching_rect" : [ 129.0, 155.0, 142.0, 23.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "LAM.dict.serialize", "@obj-desc", "Convert dict content to a series  of OSC messages." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"name" : "LAM.dict.serialize.maxpat",
				"bootpath" : "~/Documents/Max/Packages/lam-lib/patchers",
				"patcherrelativepath" : "../patchers",
				"type" : "JSON",
				"implicit" : 1
