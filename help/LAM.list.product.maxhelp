...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 104.0, 176.5, 97.0, 22.0 ],
					"style" : "",
					"text" : "LAM.list.product"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 104.0, 213.0, 79.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 104.0, 134.5, 92.0, 22.0 ],
					"style" : "",
					"text" : "1 2 3 4 5 6"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "LAM.list.product", "@obj-desc", "Compute the product of all items in a list." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
