...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 148.0, 53.0, 20.0 ],
					"text" : "bpm"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 173.0, 148.0, 65.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 173.0, 117.0, 89.0, 20.0 ],
					"text" : "LAM.taptempo"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "LAM.taptempo", "@obj-desc", "Tap it to know the tempo." ],
					"id" : "obj-5",
					"maxclass" : "bpatcher",
