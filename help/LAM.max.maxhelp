    ...
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 336.0, 229.0, 160.0, 22.0 ],
                    "presentation_linecount": 2,
                    "text": "reveal \"~/Documents/Max 9\""
                }
            },
            {
                "box": {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-14", 0 ],
                    "midpoints": [ 345.5, 262.0, 57.5, 262.0 ],
                    "source": [ "obj-9", 0 ]
                }
            }
        ],
