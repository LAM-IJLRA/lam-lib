...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 558.833374, 151.5, 37.0, 22.0 ],
					"style" : "",
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 558.833374, 52.0, 275.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 558.833374, 120.0, 77.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 558.833374, 91.5, 77.0, 22.0 ],
					"style" : "",
					"text" : "zl ecils 1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 184.0, 128.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 127.0, 154.5, 20.0 ],
									"style" : "",
									"text" : "expr pow($f1\\,$f2)"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.0, 499.5, 345.0, 154.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 176.0, 168.0, 20.0 ],
									"style" : "",
									"text" : "LAM.closest"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 218.5, 309.0, 50.0, 18.0 ],
									"style" : "",
									"text" : "72."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 276.5, 271.0, 32.5, 20.0 ],
									"style" : "",
									"text" : "+ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 104.0, 234.0, 32.5, 20.0 ],
									"style" : "",
									"text" : "t f 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 50.0, 234.0, 41.0, 20.0 ],
									"style" : "",
									"text" : "t 0 12"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 50.0, 206.0, 73.0, 20.0 ],
									"style" : "",
									"text" : "sel 12"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 290.0, 193.0, 111.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 50.0, 120.5, 223.5, 20.0 ],
									"style" : "",
									"text" : "% 12."
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 558.833374, 20.5, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 696.333374, 485.5, 186.5, 485.5 ],
					"source" : [ "obj-12", 1 ]
				}
